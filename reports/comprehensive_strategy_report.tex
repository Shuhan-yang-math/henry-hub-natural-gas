...
Net Sortino & 3.663 & 3.787 & \textbf{3.880}\\
Net CAGR & \textbf{19.20\%} & 18.75\% & 19.06\%\\
Maximum drawdown & -5.30\% & -4.51\% & \textbf{-4.16\%}\\
Daily win rate & \textbf{54.06\%} & 53.78\% & 52.29\%\\
Total net return & \textbf{240.11\%} & 231.09\% & 237.16\%\\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Selected D1--3 + amplifier} & 2.781 & \textbf{2.279} & \textbf{1.835} & \textbf{2.228} & 19.06\% & \textbf{-4.16\%}\\
\bottomrule
\end{tabular}
\end{table}
...
2020 & 26.55\% & 2.828 & 2024 & 27.27\% & 3.265\\
