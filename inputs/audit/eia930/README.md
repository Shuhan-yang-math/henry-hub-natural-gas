...
The pinned daily source is
`eia930_southeast_daily_multifuel.parquet` (2,751 days by 18 respondents,
SHA-256 `332bbf025b5f9536adf5148aa40be09cd80f596d49a39f058f1d7eea132542e4`).
`florida_available_ba_signal_history.parquet` is its deterministic Florida
