...
DEFAULT_SABINE_NOMINATION_INPUT_MANIFEST = (
    PROJECT_ROOT
...
SABINE_NOMINATION_ALL_CYCLE_ARTIFACT_ID = (
    "sabine_nomination_all_cycle_oac"
)
SABINE_NOMINATION_PANEL_ARTIFACT_ID = "sabine_nomination_research_panel"
SABINE_NOMINATION_EXECUTION_ARTIFACT_ID = (
    "sabine_nomination_execution_windows"
)
