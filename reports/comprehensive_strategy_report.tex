...
Selected common sample: & July 25, 2019--July 13, 2026; 1,735 trading days\\
...
Sharpe, zero risk-free rate & \textbf{1.667} & \textbf{1.717}\\
...
The selected D1--3 version can be compared on a common 1,735-day overlap from
...
\midrule
Net Sharpe & 2.139 & 2.193 & \textbf{2.240}\\
Net Sortino & 3.703 & 3.815 & \textbf{3.910}\\
Net CAGR & \textbf{19.24\%} & 18.71\% & 19.02\%\\
Maximum drawdown & -5.29\% & \textbf{-4.15\%} & \textbf{-4.15\%}\\
Daily win rate & \textbf{54.06\%} & 53.66\% & 52.22\%\\
Total net return & \textbf{240.87\%} & 230.31\% & 236.39\%\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Development, 2017--2020 & 1.700 & 12.42\% & -4.39\%\\
Validation, 2021--2023 & 1.878 & 18.64\% & -5.12\%\\
First-look holdout, 2024+ & 1.407 & 12.97\% & -6.07\%\\
Full sample & \textbf{1.667} & \textbf{14.56\%} & \textbf{-6.07\%}\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Current D1--5 & \textbf{2.734} & 2.137 & 1.811 & 2.139 & \textbf{19.24\%} & -5.29\%\\
D1--3, no guard & 2.693 & 2.223 & 1.859 & 2.193 & 18.71\% & \textbf{-4.15\%}\\
\textbf{Selected D1--3 + amplifier} & 2.716 & \textbf{2.270} & \textbf{1.919} & \textbf{2.240} & 19.02\% & \textbf{-4.15\%}\\
\bottomrule
\end{tabular}
\end{table}

The D1--3 horizon provides most of the drawdown improvement. Adding the
storage amplifier raises full Sharpe from 2.193 to 2.240, validation Sharpe
