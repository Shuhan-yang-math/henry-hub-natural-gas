...
BSEE/Sabine pure short veto. All comparisons below use identical dates and
inputs.
...
\toprule
Period & D1--5 SR & Selected SR & D1--5 CAGR & Selected CAGR & D1--5 DD & Selected DD\\
\midrule
Development overlap & \textbf{2.788} & 2.742 & \textbf{24.31\%} & 23.60\% & \textbf{-2.97\%} & -3.62\%\\
Validation & 2.137 & \textbf{2.270} & \textbf{20.62\%} & 20.59\% & -5.29\% & \textbf{-4.15\%}\\
First-look & 1.811 & \textbf{1.919} & \textbf{15.30\%} & 15.01\% & -4.35\% & \textbf{-3.69\%}\\
Full common sample & 2.149 & \textbf{2.245} & \textbf{19.33\%} & 19.07\% & -5.29\% & \textbf{-4.15\%}\\
\bottomrule
\end{tabular}
\end{table}

The selected version improves the fixed validation and first-look Sharpe and
drawdown, while accepting slightly lower full-common-sample CAGR.
